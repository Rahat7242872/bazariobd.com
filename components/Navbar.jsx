            ...
            <div className="mx-6">
                <div className="flex items-center justify-between max-w-7xl mx-auto py-4  transition-all">
                    ...
                    <Link href="/" className="relative text-4xl font-semibold text-slate-700">
                        <span className="text-red-600">Baza</span>rio<span className="text-green-600 text-5xl leading-0">.</span>
                    ...
                    {/* Desktop Menu */}
                    <div className="hidden sm:flex items-center gap-4 font-bold lg:gap-8 text-slate-600">
                        ...
                        <form onSubmit={handleSearch} className="hidden xl:flex items-center w-xs text-sm gap-2 bg-slate-100 px-4 py-3 rounded-full">
                            ...
                            <input className="w-full bg-transparent outline-none placeholder-green-600" type="text" placeholder="Search products" value={search} onChange={(e) => setSearch(e.target.value)} required />
                        </form>
...

                   {
                    ...
                    !user ? (
                       <button onClick={openSignIn} className="px-8 py-2 bg-green-500 hover:bg-slate-600 transition text-white rounded-full">
                            Login
                        </button>
                    ) :(
                        <UserButton>
